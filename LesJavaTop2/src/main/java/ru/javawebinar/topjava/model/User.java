...
// http://spring-projects.ru/projects/spring-data/jpa/  TODO balbla
 public class User extends NamedEntity {
    ...
    public User(  String email, String password, int caloriesPerDay, boolean enabled, Set<Role> roles) {
    	super( );
    	this.email = email;
    ...
    public User(Integer id, String name, String email, String password, int caloriesPerDay, boolean enabled, Role role) {
        super(id, name);
        this.email = email;
        this.password = password;
        this.caloriesPerDay = caloriesPerDay;
